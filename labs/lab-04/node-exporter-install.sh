...
## Updated November, 2025. Written by Dave Prowse: https://prowse.tech

## This script will install the Prometheus node_exporter and run it as a service. 

## It is tested on AMD64 and ARM64-based systems including: Ubuntu 22.04, Ubuntu 24.04, Debian 12 & 13, and Centos 9, but should work on other systemd-based Linux distros as well.
