...
## Updated February, 2026. Written by Dave Prowse: https://prowse.tech

## This script will install the Prometheus alert_manager and run it as a service. 

## It is tested on AMD64 and ARM64 - Ubuntu 22.04/24.04, Debian 12/13, and Centos 9, but should work on other systemd-based Linux distros as well.
...
# Variables
ALERTMANAGER_VERSION=v0.31.0
ALERTMANAGER_AMD64=alertmanager-0.31.0.linux-amd64
ALERTMANAGER_ARM64=alertmanager-0.31.0.linux-arm64
